...
Fast Pizza App is a web application that allows customers to browse a menu of delicious pizzas, customize their orders, and place them seamlessly. Users can quickly order their favorite pizzas, adjust quantities, manage their cart, and track their orders.

Check out the live demo [here](https://pizzaapp-nouman.netlify.app/).

## Installation

To run Fast Pizza App locally, follow these simple steps:

# Clone the repository:

git clone https://github.com/chnoumanejaz/fast-pizza-app.git
